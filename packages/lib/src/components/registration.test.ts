...
const publicComponents = [
	...
	{ tagName: 'w1c-alert', exportName: 'W1cAlert', entrypoint: '../alert' },
	...
	{ tagName: 'w1c-checkbox', exportName: 'W1cCheckbox', entrypoint: '../checkbox' },
	...
	{ tagName: 'w1c-endpoint-row', exportName: 'W1cEndpointRow', entrypoint: '../endpoint-row' },
	...
	{ tagName: 'w1c-input', exportName: 'W1cInput', entrypoint: '../input' },
	{ tagName: 'w1c-json-viewer', exportName: 'W1cJsonViewer', entrypoint: '../json-viewer' },
	{ tagName: 'w1c-label', exportName: 'W1cLabel', entrypoint: '../label' },
	...
	{ tagName: 'w1c-select', exportName: 'W1cSelect', entrypoint: '../select' },
	{ tagName: 'w1c-source-viewer', exportName: 'W1cSourceViewer', entrypoint: '../source-viewer' },
	{ tagName: 'w1c-status-card', exportName: 'W1cStatusCard', entrypoint: '../status-card' },
	...
	{ tagName: 'w1c-textarea', exportName: 'W1cTextarea', entrypoint: '../textarea' },
	...
	{ tagName: 'w1c-validation-message', exportName: 'W1cValidationMessage', entrypoint: '../validation-message' },
